...
//error is :value of optional type Int? must be unwrapped to value of Int
...
print(userAge)
print("The value is nil because  user input age is not a valid number")
